...
final class AclActionRepository extends ServiceEntityRepository
{
    ...
    public function save(AclAction $entity, bool $flush = false): void
    {
    ...
    public function remove(AclAction $entity, bool $flush = false): void
    {
    ...
    //    /**
    //     * @return AclAction[] Returns an array of AclAction objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?AclAction
    //    {
    //        return $this->createQueryBuilder('a')
    //            ->andWhere('a.exampleField = :val')
    //            ->setParameter('val', $value)
