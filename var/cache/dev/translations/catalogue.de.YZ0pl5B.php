...
$catalogue = new MessageCatalogue('de', array (
  'validators+intl-icu' => 
  array (
    'app.user.form.error.unique.username' => 'Dieser Benutzername wird bereits verwendet.',
    'app.user.form.error.required.password' => 'Das Kennwort ist ein pflichtfeld',
    'app.user.form.error.match.password' => 'Beide Passwörter müssen stimmen.',
    'app.user.form.error.min_length.password' => 'Das Passwort muss mindestens 6 Zeichen enthalten.',
    'app.register.form.client_type.form.not_blank' => 'Ist notwendig zum informieren was für Konto es ist.',
    'app.register.form.email.form.unique' => 'Diese E-Mail wird bereits verwendet.',
  ),
  'validators' => 
  array (
  ...
  array (
    ...
    'app.access_information' => 'Zugriffsinformationen',
    'app.address_information' => 'Adressinformationen',
    'app.basic_information' => 'Allgemeine Informationen',
    'app.button.save_changes' => 'Speichern',
    'app.contact_details' => 'Kontaktinformationen',
    'app.created_at' => 'Erstellt am',
    'app.delete' => 'Löschen',
    'app.edit' => 'Bearbeiten',
    'app.add' => 'Hinzufügen',
    'app.clean' => 'Reinigen',
    ...
    'app.name' => 'Name',
    'app.logout' => 'Abmelden',
    'app.list_all' => 'Alle auflisten',
    'app.type' => 'Typ',
    'app.version' => 'Version',
    'app.all_rights_reserved' => 'Alle Rechte vorbehalten.',
    'app.loading' => 'Laden',
    'app.list.not_exist_results' => 'Leider gibt es keine result für diese seite.',
    'app.search' => 'Suche',
    'app.search_input.by_names' => 'Suche nach Namen...',
    'app.update_google_maps' => 'Google maps aktualiseren',
    'app.saved_successfully' => 'Erfolgreiche gespeichert',
    'app.form.label.country' => 'Land:',
    'app.form.label.state' => 'Region:',
    'app.form.label.city' => 'Stadt:',
    'app.form.label.neighborhood' => 'Neighborhood:',
    'app.form.label.search_postal_code' => 'Postleitzahl suchen',
    'app.form.label.address' => 'Straße:',
    'app.form.label.postal_code' => 'Postleitzahl:',
    'app.form.label.street_number' => 'Adressnummer:',
    'app.form.label.complement' => 'Addressline:',
    'app.form.label.choose' => 'Bitte auswählen:',
    'app.message.no_results_found' => 'Keine Ergebnisse gefunden',
    'app.message.successfully_found' => 'Erfolgreich gefunden',
    'app.success.upload_was_successfully' => 'Upload war erfolgreich',
    'app.login.start_your_session' => 'Melden Sie sich an',
    'app.login.remember_me' => 'Erinnern',
    'app.login.sign_in' => 'Sign In',
    'app.error.unauthorised_access' => 'Unautorisierter Zugriff',
    'app.error.upload_error' => 'Upload-Fehler',
    'app.error.error_deleting_file' => 'Fehler beim Löschen der Datei',
    'language.identifier' => 'de_DE',
    'language.translate_key.name' => 'language.translate.german',
    'language.translate.english' => 'Englisch',
    'language.translate.portuguese' => 'Portugiesisch',
    'language.translate.german' => 'Deutsch',
    'app.users' => 'Benutzer',
    'app.user.user_list' => 'Benutzerliste',
    'app.user.add_user' => 'Benutzer Hinzufügen',
    'app.user.edit_user' => 'Benutzer Bearbeiten',
    'app.user.form.label.first_name' => 'Vorname:',
    'app.user.form.label.group' => 'Gruppe:',
    'app.user.form.label.last_name' => 'Nachname:',
    'app.user.form.label.username' => 'Username:',
    'app.user.form.label.password' => 'Kennwort:',
    'app.user.form.label.repeat_password' => 'Kennwort wiederholen:',
    'app.user.form.label.birthday' => 'Geburtsdatum:',
    'app.user.form.label.bio' => 'Erzähle mehr über dich',
    'app.user.form.label.url_picture' => 'Wählen Sie einen Foto:',
    'app.user.form.button.save_user' => 'Benutzer Speichern',
    'app.user.form.label.user_type' => 'Benutzer-Typ:',
    'app.user.form.label.email' => 'E-Mail:',
    'app.user.form.label.phone_number' => 'Telefon:',
    'app.user.select_country_calling_code' => 'Wählen Sie das Land, aus dem die Nummer stammt',
    'app.user.delete_confirmation_dialog' => 'Sind Sie sicher, dass Sie die Benützer löschen möchten?',
    'app.user.form.label.delete_url_avatar' => 'Foto löschen',
    'app.user.form.label.show_picture' => 'Foto veröffentlichen',
    'app.settings' => 'Einstellungen',
    'app.settings.security' => 'Sicherheit',
    'app.settings.profile' => 'Profile',
    'app.settings.address' => 'Adresse',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  'validators+intl-icu' => 
  array (
    'app.user.form.error.unique.username' => 'This username is already used.',
    'app.user.form.error.required.password' => 'Choose a password',
    'app.user.form.error.match.password' => 'The password fields must match.',
    'app.user.form.error.min_length.password' => 'The password must contain at least 6 characters.',
    'app.register.form.client_type.form.not_blank' => 'Is necessary to inform which type of account will be created.',
    'app.register.form.email.form.unique' => 'This email is already being used.',
  ),
  'validators' => 
  array (
  ...
  array (
    ...
    'app.access_information' => 'Access information',
    'app.address_information' => 'Address information',
    'app.basic_information' => 'Basic information',
    'app.button.save_changes' => 'Save changes',
    'app.contact_details' => 'Contact details',
    'app.created_at' => 'Created at',
    'app.delete' => 'Delete',
    'app.edit' => 'Edit',
    'app.add' => 'Add',
    'app.clean' => 'Clean',
    ...
    'app.name' => 'Name',
    'app.logout' => 'Logout',
    'app.list_all' => 'List all',
    'app.type' => 'Type',
    'app.version' => 'Version',
    'app.all_rights_reserved' => 'All rights reserved.',
    'app.loading' => 'Loading',
    'app.list.not_exist_results' => 'Unfortunately don\'t exist results in this page.',
    'app.search' => 'Search',
    'app.search_input.by_names' => 'Search by names...',
    'app.update_google_maps' => 'Update google maps',
    'app.saved_successfully' => 'Saved successfully',
    'app.form.label.country' => 'Country:',
    'app.form.label.state' => 'State:',
    'app.form.label.city' => 'City:',
    'app.form.label.neighborhood' => 'Neighborhood:',
    'app.form.label.search_postal_code' => 'Search postal code',
    'app.form.label.address' => 'Address:',
    'app.form.label.postal_code' => 'Postal code:',
    'app.form.label.street_number' => 'Street number:',
    'app.form.label.complement' => 'Complement:',
    'app.form.label.choose' => 'Select:',
    'app.message.no_results_found' => 'No results found',
    'app.message.successfully_found' => 'Successfully found',
    'app.success.upload_was_successfully' => 'Upload was successfully',
    'app.login.start_your_session' => 'Sign in to start your session',
    'app.login.remember_me' => 'Remember me',
    'app.login.sign_in' => 'Sign In',
    'app.error.unauthorised_access' => 'Unauthorised access',
    'app.error.upload_error' => 'Upload error',
    'app.error.error_deleting_file' => 'Error while deleting file',
    'language.identifier' => 'en_US',
    'language.translate_key.name' => 'language.translate.english',
    'language.translate.english' => 'English',
    'language.translate.portuguese' => 'Portuguese',
    'language.translate.german' => 'German',
    'app.users' => 'Users',
    'app.user.user_list' => 'User list',
    'app.user.add_user' => 'Add user',
    'app.user.edit_user' => 'Edit user',
    'app.user.form.label.first_name' => 'First Name:',
    'app.user.form.label.group' => 'Group:',
    'app.user.form.label.last_name' => 'Last Name:',
    'app.user.form.label.username' => 'Username:',
    'app.user.form.label.password' => 'Password:',
    'app.user.form.label.repeat_password' => 'Repeat password:',
    'app.user.form.label.birthday' => 'Birthday:',
    'app.user.form.label.bio' => 'About you:',
    'app.user.form.label.url_picture' => 'Choose a picture:',
    'app.user.form.button.save_user' => 'Save user',
    'app.user.form.label.user_type' => 'User type:',
    'app.user.form.label.email' => 'Email:',
    'app.user.form.label.phone_number' => 'Phone number:',
    'app.user.select_country_calling_code' => 'Select which country the number originates from',
    'app.user.delete_confirmation_dialog' => 'Are you sure you want to delete the user?',
    'app.user.form.label.delete_url_avatar' => 'Delete picture from user',
    'app.user.form.label.show_picture' => 'Publish picture',
    'app.settings' => 'Settings',
    'app.settings.security' => 'Security and Login',
    'app.settings.profile' => 'Profile',
