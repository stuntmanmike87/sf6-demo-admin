...
$catalogue = new MessageCatalogue('pt', array (
  'validators+intl-icu' => 
  array (
    'app.user.form.error.unique.username' => 'Este nome de usuário já é utilizado. Por favor utilize uma outra.',
    'app.user.form.error.required.password' => 'Informe uma senha',
    'app.user.form.error.match.password' => 'Os campos de senha devem corresponder.',
    'app.user.form.error.min_length.password' => 'A senha precisa conter no mínimo 6 caracteres.',
    'app.register.form.client_type.form.not_blank' => 'E necessario informar o tipo da conta.',
    'app.register.form.email.form.unique' => 'Esse email ja esta sendo usado.',
  ),
  'validators' => 
  array (
  ...
  array (
    ...
    'app.access_information' => 'Informações de acesso',
    'app.address_information' => 'Informações de Endereço',
    'app.basic_information' => 'Informações básicas',
    'app.button.save_changes' => 'Salvar atualizações',
    'app.contact_details' => 'Contatos',
    'app.created_at' => 'Cadastrado em',
    'app.delete' => 'Excluir',
    'app.edit' => 'Editar',
    'app.add' => 'Adicionar',
    'app.clean' => 'Limpar',
    ...
    'app.name' => 'Nome',
    'app.logout' => 'Sair',
    'app.list_all' => 'Listar todos',
    'app.type' => 'Tipo',
    'app.version' => 'Versão',
    'app.all_rights_reserved' => 'Todos os direitos reservados.',
    'app.loading' => 'Carregando',
    'app.list.not_exist_results' => 'Infelizmente não foi encontrado nenhum resultado.',
    'app.search' => 'Pesquisar',
    'app.search_input.by_names' => 'Pesquisar por nomes...',
    'app.update_google_maps' => 'Atualizar google maps',
    'app.saved_successfully' => 'Salvo com sucesso',
    'app.form.label.country' => 'País',
    'app.form.label.state' => 'Estado',
    'app.form.label.city' => 'Cidade',
    'app.form.label.neighborhood' => 'Bairro',
    'app.form.label.search_postal_code' => 'Pesquisar CEP',
    'app.form.label.address' => 'Endereço:',
    'app.form.label.postal_code' => 'CEP:',
    'app.form.label.street_number' => 'Número da rua:',
    'app.form.label.complement' => 'Complemento:',
    'app.form.label.choose' => 'Escolha:',
    'app.message.no_results_found' => 'Nenhum resultado encontrado',
    'app.message.successfully_found' => 'Encontrado com sucesso',
    'app.success.upload_was_successfully' => 'O Upload foi bem-sucedido',
    'app.login.start_your_session' => 'Faca seu login aqui',
    'app.login.remember_me' => 'Lembrar me',
    'app.login.sign_in' => 'Entrar',
    'app.error.unauthorised_access' => 'Acesso não autorizado',
    'app.error.upload_error' => 'Erro no upload',
    'app.error.error_deleting_file' => 'Erro ao apagar o arquivo',
    'language.identifier' => 'pt_BR',
    'language.translate_key.name' => 'language.translate.portuguese',
    'language.translate.english' => 'Inglês',
    'language.translate.portuguese' => 'Português',
    'language.translate.german' => 'Alemão',
    'app.users' => 'Usuários',
    'app.user.user_list' => 'Listagem de Usuários',
    'app.user.add_user' => 'Add user',
    'app.user.edit_user' => 'Editar usuário',
    'app.user.form.label.first_name' => 'Primeiro nome:',
    'app.user.form.label.group' => 'Grupo:',
    'app.user.form.label.last_name' => 'Último nome:',
    'app.user.form.label.username' => 'Login:',
    'app.user.form.label.password' => 'Senha:',
    'app.user.form.label.repeat_password' => 'Repetir senha:',
    'app.user.form.label.birthday' => 'Data de nascimento:',
    'app.user.form.label.bio' => 'Sobre me:',
    'app.user.form.label.url_picture' => 'Escolhe uma foto:',
    'app.user.form.button.save_user' => 'Salvar usuário',
    'app.user.form.label.user_type' => 'Tipo de usuário:',
    'app.user.form.label.email' => 'E-mail:',
    'app.user.form.label.phone_number' => 'Telefone:',
    'app.user.select_country_calling_code' => 'Selecione qual país origin do número',
    'app.user.delete_confirmation_dialog' => 'Você tem certeza de que quer deleter o usuário?',
    'app.user.form.label.delete_url_avatar' => 'Deletar a foto do usuário',
    'app.user.form.label.show_picture' => 'Mostrar foto',
    'app.settings' => 'Configurações',
    'app.settings.security' => 'Segurança & Login',
    'app.settings.profile' => 'Perfil',
    'app.settings.address' => 'Endereço',
  ),
));
