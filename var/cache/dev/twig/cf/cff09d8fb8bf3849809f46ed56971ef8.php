...
/* base.html.twig */
class __TwigTemplate_8c9549435a28dd9c038e97f6de08918e extends Template
{
    private $source;
    private $macros = [];
...
<html lang=\"";
        // line 2
        echo twig_escape_filter($this->env, twig_replace_filter($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("language.identifier", [], null, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 2, $this->source); })()), "request", [], "any", false, false, false, 2), "locale", [], "any", false, false, false, 2)), ["_" => "-"]), "html", null, true);
        echo "\">
    <head>
        <meta charset=\"UTF-8\">
    ...
    <body";
        // line 20
        $this->displayBlock('addAttrBody', $context, $blocks);
        echo ">
    ";
        // line 21
...
";
    ...
    {
        return array (  225 => 34,  215 => 33,  201 => 28,  193 => 24,  183 => 23,  165 => 21,  147 => 20,  134 => 16,  124 => 15,  105 => 13,  93 => 36,  91 => 33,  88 => 32,  86 => 23,  83 => 22,  81 => 21,  77 => 20,  73 => 18,  71 => 15,  66 => 13,  52 => 2,  49 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<!DOCTYPE html>
<html lang=\"{{ 'language.identifier'|trans([], null, app.request.locale)|replace({'_':'-'}) }}\">
    <head>
        <meta charset=\"UTF-8\">
        <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">
        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, user-scalable=no\">
    ...
    <body{% block addAttrBody %}{% endblock %}>
    {% block body %}{% endblock %}
...
", "base.html.twig", "/Users/thomaskaenzig/projects/symfony-demo-administrator/templates/base.html.twig");
    }
}
